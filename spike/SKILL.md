...
## Long-Duration Batch Outputs

When a spike generates many independent files (videos, rendered images, multi-sector analyses), individual task times can exceed the Hermes 60s polling clamp. The `references/batch-long-tasks.md` file documents the subprocess-spawning pattern for this situation.
