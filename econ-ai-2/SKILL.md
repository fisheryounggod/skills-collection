...
compatibility: [claude-code, openclaw, cursor, gemini-cli]
---
...
Skills are pre-installed in ~/.openclaw/skills/econ-ai/

For manual installation:
```bash
mkdir -p ~/.openclaw/skills
git clone https://github.com/meleantonio/awesome-econ-ai-stuff.git ~/.openclaw/skills/econ-ai
```
