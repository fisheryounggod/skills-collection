...
**NEW:** Now includes 10 professional investment bank-grade analysis templates for in-depth due diligence, financial statement analysis, valuation modeling, risk scanning, and comprehensive research reports.
---
...
## 🚀 NEW: Professional Analysis Templates

### Overview

This skill now includes **10 investment bank-grade analysis templates** for professional-grade stock research:

| Template | Use Case | Complexity |
|----------|----------|-----------|
| 1. 完整股票分析 | Comprehensive company overview | ⭐⭐⭐ |
| 2. 财务报表深度分析 | Deep financial statement analysis | ⭐⭐⭐⭐ |
| 3. 财报分析器 | Earnings report analysis | ⭐⭐ |
| 4. 行业与板块比较 | Multi-stock comparison | ⭐⭐⭐ |
| 5. 估值模型构建器 | Professional valuation modeling | ⭐⭐⭐⭐⭐ |
| 6. 股息和被动收入分析器 | Dividend and income analysis | ⭐⭐⭐ |
| 7. 风险与红旗扫描器 | Risk assessment and red flag detection | ⭐⭐⭐⭐ |
| 8. ETF和投资组合分析器 | Portfolio and ETF analysis | ⭐⭐⭐ |
| 9. 宏观和市场情绪扫描器 | Macro environment analysis | ⭐⭐⭐⭐ |
| 10. 完整尽职调查报告 | Full due diligence research report | ⭐⭐⭐⭐⭐ |

### Quick Reference

**For detailed prompt templates, see:**
- `PROFESSIONAL_PROMPTS.md` - Complete templates for all 10 analysis types
...
- Explicit citations (SEC filings, Bloomberg, etc.)
- Clear distinction between facts and assumptions
- "N/A" or "未公开" for missing data

**2. Professional Frameworks**
- DCF valuation with sensitivity analysis
- Comparable company analysis
- Three-scenario modeling (bull/base/bear)
- Quality checks and red flags

**3. Comprehensive Coverage**
- Business model and competitive moat
- Financial health and quality
- Growth drivers and TAM analysis
- Risk assessment and mitigation
- Catalyst calendar and timeline

**4. Actionable Recommendations**
- Clear ratings (Buy/Hold/Sell)
- Target prices with probability
- Risk-return assessment
- Portfolio allocation suggestions

### Integration with Existing Workflows

These professional templates complement the basic analysis workflows:

- **For Basic Info queries**: Use Template 1 (完整股票分析)
- **For Fundamental Analysis**: Use Template 2 (财务报表深度分析)
- **For Comparisons**: Use Template 4 (行业与板块比较)
- **For Comprehensive Reports**: Use Template 10 (完整尽职调查报告)

### When to Use Professional Templates

**Use when:**
- User requests "深度分析" (deep analysis)
- User needs valuation modeling
- User asks for risk assessment
- User wants professional investment reports
- User requests due diligence
- User mentions "投资银行级别" (investment bank grade)

**Basic workflows still preferred for:**
